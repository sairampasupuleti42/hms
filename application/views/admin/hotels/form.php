...
<section class="content">
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            ...
            <div class="box-tools"><a href="<?php echo base_url() ?>admin/hotels/" class="btn btn-danger btn-sm">Back
                    to
                    Hotels</a></div>
        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group hide" id="checkApp">
                                        <label class="control-label col-sm-9" for="hotelRoomPrice">Apply Same price for
                                            all
                                        </label>
                                        <div class="col-sm-3">
